  ...
  return (
    <div className="py-8 px-6 xl:px-10 w-full flex flex-col items-center text-center space-y-4">
      ...
      <p className="text-xs text-gray-500 leading-relaxed max-w-sm mx-auto">
        Bộ phận kỹ sư của chúng tôi chuyên hỗ trợ chủ doanh nghiệp biên soạn nội dung, thiết kế hình ảnh thu hút nhất.
        Liên lạc trực tuyến hoàn toàn miễn phí qua Zalo hotline.
      </p>
      <p className="font-mono text-base font-bold text-primary underline">Hotline 24/7 Zalo: 0987.654.321</p>
    </div>
  );
}
