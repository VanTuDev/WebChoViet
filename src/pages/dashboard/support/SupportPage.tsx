...
export default function SupportPage() {
  return (
    <div className="py-8 px-6 xl:px-10 w-full flex flex-col items-center text-center space-y-4">
      <HelpCircle className="h-12 w-12 text-[#00aaff] mx-auto" />
      ...
      <p className="font-mono text-base font-bold text-indigo-700 underline">Hotline 24/7 Zalo: 0987.654.321</p>
    </div>
  );
}
