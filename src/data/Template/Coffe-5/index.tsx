...
export default function Coffe5({ lang = 'vi' }: Props) {
      ...
      <header data-section="nav" className="fixed top-0 w-full z-50 bg-[#FFFBEB]/80 backdrop-blur-md shadow-sm">
        <nav className="flex justify-between items-center px-6 py-3 max-w-[1280px] mx-auto">
          ...
          <div className="flex items-center gap-3 text-sm font-medium text-[#92400e]">
            <span>VN</span><span className="opacity-50">|</span><span>EN</span><span className="opacity-50">|</span><span>ZH</span><span className="opacity-50">|</span><span>KO</span>
          </div>
        </nav>
      </header>
          ...
          <div className="max-w-[1280px] mx-auto px-6">
            <div className="flex justify-between items-end mb-10">
              ...
              <div className="flex gap-3">
                ...
                <button onClick={() => scrollCarousel('next')} className="w-10 h-10 rounded-full border border-[#fde68a] bg-white text-[#92400e] flex items-center justify-center hover:bg-[#FEF3C7] transition-all">
        ...
        <div className="max-w-[1280px] mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div>
            ...
            <form className="flex gap-2" onSubmit={(e) => e.preventDefault()}>
              ...
              />
              <button type="submit" className="px-6 py-2 bg-white text-primary rounded-full text-sm font-medium hover:bg-[#e0e3e5] transition-colors">
