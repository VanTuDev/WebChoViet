      ...
      <header data-section="nav" className="fixed top-0 w-full z-50 bg-[#f7f9fb]/80 backdrop-blur-md shadow-sm">
        <div className="flex justify-between items-center h-20 px-6 max-w-[1280px] mx-auto">
          ...
          <div className="flex items-center gap-3">
            <button className="text-sm font-medium text-[#424752] hover:text-primary px-4 py-2 hidden sm:block">{t.nav.login}</button>
            <button className="text-sm font-medium bg-primary text-white rounded-full px-6 py-2 hover:bg-primary-container transition-colors active:scale-95 duration-150 shadow-sm">{t.nav.start}</button>
          </div>
        </div>
      </header>
        ...
        <section data-section="drinks" className="py-20 bg-[#f7f9fb]">
          <div className="max-w-[1280px] mx-auto px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {/* Item 1 */}
              <div className="group rounded-2xl bg-white border border-[#e0e3e5] overflow-hidden hover:shadow-[0_12px_32px_rgba(46,78,63,0.08)] transition-all duration-300 hover:-translate-y-1">
