...
const DEFAULT_IMGS = {
  heroBg:  'https://lh3.googleusercontent.com/aida-public/AB6AXuDmou1haC8jNjkiDUuGynK92mspCztxLFVfY1dYoGPMbAQATHwSvEC2cHgQiDz-BFVFrJtjEGErUhJR4llJmXQoCLVbpheItOoBW8q7IJgQM_DTy5y4lo8u9mNjxZgqD7UmW8ShyLOVH99lsTildOCUc0ciA_tQzOsM8gXGlffw6Vzzltu9w3ldYHJQgadAhlrIkiuSpIHFDkEsn4iAWADnhbTUlb_PP5knkwZDYEemW2IZWPiYYeB1',
  bentoImg: 'https://lh3.googleusercontent.com/aida-public/AB6AXuD801JhZRw5z8u53m-vgJ8N9AM0H02ODM7BWfFT7A5WEwjWF67bt3SDp_UUqltDLM3JY8boovhIykCcXwF7a01OUOGBwD1_GHI8rtGkJQ1ex5ypVF07qNnPJyVgeaF6wF1xnSHHpFnRjcYLZbTwdqZjQb5fs9TzYa9DRVsc0rdsQHZ_62tBaBpbOsbqAPd4NMaHpiXttVukTcxFedNZFABykK198VszzTb4mY3Mkh-Rpy-PZV_5qDPt',
  gallery1: 'https://lh3.googleusercontent.com/aida-public/AB6AXuBmF58Vl8VWwhbGRAs-jnD8dAuJCA_JR_dyQGiAqWGmWHOk4CGw5SQQMpKvq184O-5ukFpOJDpQfW-nDicMZvSaQ_bHx8HM9zwu1G2CnmKoBIe0FAWuwhQyU9irc0iFa1a4U8VogEh4FDYPjQF8hXUEKGGHQ5Otdid83h894evGb_eNKV6QzaMhuQ5YWN958eBCzOOm9CgjsVHHoFHprs06o35uJTV6gyZQbm9hIKZg4A3A0deaYCSp',
  gallery2: 'https://lh3.googleusercontent.com/aida-public/AB6AXuBd91O1YHSRbVHHsx7I_JfMDWqKg044MI4-fk_qDBuJe9ZjNZbS3SrHqLmjR0_mlIbPFsWQTBGBT3uBJDJSGWZcASPDK5IaHKxPkPVVbCEZI_VhzIOI_6wrXV7IzcvB6OYuI1Da9qyoldt8yW279RPcDhV_RWswC_qX9zrSFSptuoMFzPj-q_ukm9b5t1qyKCidKrTqnZbQYklHdZ00b-bexBdaSLQKBmY6DORWuY0ZeLTA28uas_7d',
  gallery3: 'https://lh3.googleusercontent.com/aida-public/AB6AXuApFB7MPugIx4OqIBEa6wa9V40_9-140Gqryt4q-INF3l-eaaM4Nj7i3gegeIv9e3CWWnpqad5-1HB6AH5Jm75wmN1AmiLvxW73CQDbfJ-bDx8k5Llhe96B0emIXSmOwvP6yAQFTzyK-haIc7RQOP92kAXG1njHOUmCJqgyei86NrDsZKsmBd9udHo3d2jQziB4-ps4ZNOv_-O3sRVS6z05Uo299qzd99WDk_zmhfys1Y0FXxZ0PR8c',
};
                  ...
                  return (
                    <div key={i} className="md:col-span-2 md:row-span-2 bg-white/70 backdrop-blur-md border border-white/40 p-8 rounded-3xl flex flex-col justify-between group hover:shadow-2xl hover:shadow-[#0ea5e9]/10 transition-all duration-500">
                      ...
                      <div className="mt-8 overflow-hidden rounded-2xl relative h-48">
                        <img className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700" src={IMG.bentoImg} alt={item.title} />
                      </div>
                    </div>
                  );
                }
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[IMG.gallery1, IMG.gallery2, IMG.gallery3].map((img, i) => (
                <div key={i} className={`group relative overflow-hidden rounded-[2rem] aspect-[4/5] shadow-xl ${i === 1 ? 'md:translate-y-12' : ''}`}>
                  <img className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" src={img} alt={t.gallery.steps[i]?.title ?? ''} />
