 ...
 * ─── Template Registry ────────────────────────────────────────────────────────
 *
 * NGUỒN SỰ THẬT DUY NHẤT cho toàn bộ hệ thống template.
 *
 * ┌──────────────────────────────────────────────────────────────────────────┐
 * │  THÊM TEMPLATE MỚI — CHỈ SỬA FILE NÀY                                  │
 * │                                                                          │
 * │  1. Tạo folder:  src/data/Template/<category>/<TemplateName>/           │
 * │     └── index.tsx          (React component)                             │
 * │     └── i18n/vi.json       (nội dung mặc định tiếng Việt)               │
 * │     └── i18n/en.json       (optional: English)                          │
 * │     └── i18n/zh.json       (optional: Chinese)                          │
 * │     └── i18n/ko.json       (optional: Korean)                           │
 * │                                                                          │
 * │  2. Thêm category vào CATEGORY_REGISTRY (nếu category mới).             │
 * │                                                                          │
 * │  3. Thêm 1 object vào TEMPLATE_REGISTRY bên dưới.                       │
 * │     → component  : lazy(() => import('../Template/<category>/<Name>/index'))
 * │     → schema     : import JSON vi.json ở trên                           │
 * │     → imageSlots : mảng các ảnh cần tùy chỉnh của template này         │
 * │                                                                          │
...
// ── Schema imports (vi.json dùng làm field schema cho editor) ─────────────────
...
/** Template đầy đủ với runtime fields — dùng nội bộ trong registry */
interface TemplateDefinition extends Template {
...
// ── Category Registry ─────────────────────────────────────────────────────────
// Thêm category mới → thêm 1 object vào đây.
...
// ── Template Registry ─────────────────────────────────────────────────────────
// Thêm template mới → thêm 1 object vào đây.
...
export const COMPONENT_MAP: Record<string, LazyExoticComponent<ComponentType<{ lang?: string }>>> =
